...
/**
 * @file
 * Contains Drupal\brafton_importer\Model\BraftonErrorReport
 */
...
class BraftonErrorReport {
    ...
    public function __construct($api, $brand, $debug){
      ...
      //  $this->domain = 'x';
        ...
        $this->brafton_e_log = $this->brafton_config->get('brafton_importer.brafton_e_log');
    ...
    private function b_e_log(){
        ...
        if (!$brafton_error = $this->brafton_config->get('brafton_importer.brafton_e_log')) {
            $this->brafton_config->set('brafton_importer.brafton_e_log', '')->save();
            $brafton = array();
        }
        else {
            $brafton_error = $this->brafton_config->get('brafton_importer.brafton_e_log');
    ...
    public function make_local_report($e, $errorLevel){
             ...
             * update_option('brafton_e_log', $brafton_error);
             */
            $this->brafton_config->set('brafton_importer.brafton_e_log', $brafton_error)->save();
